      ...
      <div class="overflow-x-auto">
        <table class="w-full">
          <thead class="bg-gradient-to-r from-[#FF4D94]/5 to-[#7C4DFF]/5 border-b border-gray-100">
            <tr>
              <th class="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-black text-gray-700 uppercase tracking-wider">标题</th>
              <th class="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-black text-gray-700 uppercase tracking-wider">状态</th>
              <th class="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-black text-gray-700 uppercase tracking-wider">审核</th>
              <th v-if="postsData.isSuperAdmin" class="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-black text-gray-700 uppercase tracking-wider">作者</th>
              <th class="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-black text-gray-700 uppercase tracking-wider">发布时间</th>
              <th class="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-black text-gray-700 uppercase tracking-wider">阅读</th>
              <th class="px-4 sm:px-6 py-3 sm:py-4 text-right text-xs sm:text-sm font-black text-gray-700 uppercase tracking-wider">操作</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-100">
            ...
            >
              <td class="px-4 sm:px-6 py-4">
                <div class="font-black text-sm sm:text-base text-gray-900 line-clamp-2 group-hover:text-[#FF4D94] transition-colors">{{ post.title }}</div>
                <div class="text-xs text-gray-500 mt-1 font-medium">/blog/{{ post.slug }}</div>
              </td>
              <td class="px-4 sm:px-6 py-4">
                <span :class="[
                  'inline-flex items-center gap-1 px-2.5 sm:px-3 py-1 rounded-xl text-xs font-bold',
              ...
              <td v-if="postsData.isSuperAdmin" class="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-600 font-bold">
                {{ post.profiles?.name ? `${post.profiles.name}的家庭` : '未知家庭' }}
              </td>
              <td class="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-600 font-medium">
                {{ post.published_at ? formatDate(post.published_at) : '-' }}
              </td>
              <td class="px-4 sm:px-6 py-4">
                <div class="flex items-center gap-1 text-xs sm:text-sm text-gray-600 font-bold">
