...
export function FeedbackModal({
  ...
  const t = {
    zh: {
      title: isSuperAdmin ? '反馈管理中心' : '反馈与建议',
      subtitle: isSuperAdmin ? '查看和回复用户反馈' : '向管理员发送反馈',
      createNew: '新建反馈',
      backToList: '返回列表',
      myFeedback: '我的反馈',
      allFeedback: '所有反馈',
      subject: '主题',
      subjectPlaceholder: '简要描述您的问题或建议',
      message: '详细说明',
      messagePlaceholder: '请详细描述您的问题、建议或遇到的情况...',
      category: '分类',
      categories: {
        general: '一般反馈',
        bug: '错误报告',
      ...
      cancel: '取消',
      noFeedback: '暂无反馈',
      noFeedbackDesc: isSuperAdmin ? '目前没有用户反馈' : '您还没有提交过反馈',
      replies: '回复',
  ...
  const handleSubmitFeedback = async () => {
    ...
    setSubmitting(true);
    try {
      // 先获取当前用户的 profile 信息，确保使用正确的 family_id
